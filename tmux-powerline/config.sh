...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="tandy"
...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/d3/k5607p515px_00dhwzv3f41h0000gn/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/yitaimin/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/yitaimin/.mailcheckrc"
# }
...
# weather.sh {
	...
	TMUX_POWERLINE_SEG_WEATHER_LAT="30.63"
	TMUX_POWERLINE_SEG_WEATHER_LON="114.24"
# }
